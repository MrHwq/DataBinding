 ...
 */
public class BindingViewPagerAdapter<T> extends PagerAdapter implements
    ...
    @Override
    public ViewDataBinding onCreateBinding(LayoutInflater inflater, @LayoutRes int layoutRes,
                                           ViewGroup viewGroup) {
