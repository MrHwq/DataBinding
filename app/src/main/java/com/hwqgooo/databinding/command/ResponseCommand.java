package com.hwqgooo.databinding.command;
...
public class ResponseCommand<T, R> {
     ...
     */
    public ResponseCommand(Consumer<R> execute) {
    ...
    public ResponseCommand(Consumer<R> execute, Callable<Boolean> canExecute0) {
        this.execute0 = execute;
